...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_SESSION['tax_id'] = uploadFile('tax_id');
    $_SESSION['authorized_share_capital'] = uploadFile('authorized_share_capital');
...
<div class="container mt-5">
    ...
    <form action="page1.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="contact_person_nin_bvn_1" name="contact_person_nin_bvn_1" required>
        </div>
        <div class="mb-3">
            <label for="contact_person_nin_bvn_2" class="form-label">Contact Person's NIN/BVN 2</label>
            <input type="text" class="form-control" id="contact_person_nin_bvn_2" name="contact_person_nin_bvn_2">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" id="tax_id" name="tax_id" required>
            <span class="smfs-6">File Type: .jpg,.jpeg,.png,.pdf | Max. Size: 1MB</span>
        </div>
        <div class="mb-3">
            <label for="authorized_share_capital" class="form-label">Authorized Share Capital</label>
            <input type="file" class="form-control" id="authorized_share_capital" name="authorized_share_capital" accept=".jpg,.jpeg,.png,.pdf" required>
            <span class="smfs-6">File Type: .jpg,.jpeg,.png,.pdf | Max. Size: 1MB</span>
        </div>
        <div class="mb-3">
            <label for="type" class="form-label">Storage Capacity - Type</label>
            <input type="text" class="form-control" id="type" name="type" required>
        </div>
        <div class="mb-3">
            <label for="size" class="form-label">Storage Capacity - Size</label>
            <input type="text" class="form-control" id="size" name="size" required>
        </div>
        <div class="mb-3">
            <label for="location" class="form-label">Storage Capacity - Location</label>
        ...
        <div class="mb-3">
            ...
            <input type="tel" pattern="[0-9]*" maxlength="11" required="required" placeholder="08012345678" class="form-control" id="phone_number" name="phone_number" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="quantity_of_commodity" class="form-label">Quantity of Commodity</label>
